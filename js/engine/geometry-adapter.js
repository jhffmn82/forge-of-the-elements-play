...
function walkable(x,y){var p=propGrid?propAt(x,y):null;return terrainRules.walkable(at(x,y),!!(p&&p.b),floorMeta.exitOpen);}
function passable(x,y){var p=propGrid?propAt(x,y):null;return terrainRules.passable(at(x,y),!!(p&&p.b),floorMeta.exitOpen);}
...
function visionRockBand(context){if(ptMat()&&vis)FoteGeometry.revealRock(context.view);}
